...
create table suppliers (supplierID bigint(15) NOT NULL Auto_Increment, supplierName varchar(20) NOT NULL, postCode varchar(9) NOT NULL,
...
notes varchar(100), reveived tinyint(1), authorisation tinyint(1) NOT NULL, Primary Key (itemID, orderID),
